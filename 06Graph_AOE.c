/*
*						    
*	Project #4: Activity-on-Edge(AOE) Networks   
*						     
...
Part 1 . According to given tasks to creat graph
Part 2 . Calculate critical path exist or not


Step :

Part 1.
1.Read tasks in file , and calculate number of vertices.
2.According to begin & end of tasks, creat relation of vertices.
typedef struct ArcNode
typedef struct VNode
typedef struct ALGraph

Part 2.
3.Use in-degree of vertices to calculate longest path length of vertices.
FindInDegree()
TopologicalOrder() 
4.With data of longest path length , calculate early time & latest time
5.If early time equal to latest time , this task is critical path.
CriticalPath()
