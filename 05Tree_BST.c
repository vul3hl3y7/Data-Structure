/*******************************************************
*
*	Assigment D : Binary Search Tree and Max-Heap
*	Writer : Meng Tseng Tasi
*
/*******************************************************

1.Use command "make" to makefile.
2.Use command "./hwd" to run program.
...
(1)If value doesn't exist, (2) and (3) will show wrong message.
(2)User should use (1) to enter some values into tree, or (2), (3), (4), (5) won't show anything.
