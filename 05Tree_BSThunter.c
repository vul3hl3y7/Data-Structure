...
1.Implement a Binary Search Tree with linkes lists
=======================================
=                                     =
= Please choose the instruction.      =
= (I)insert                           =
= (D)delete                           =
= (S)search                           =
= (P)print                            =
...
I - insert node to binary search tree.
(If user want to input data in one line can input I(number)I(number)I(numbder)...)
D - delete data in binary search tree.
S - search data in binary search tree.
(If data not find will show wrong message.)
P - print binary search tree with infix-order(I-order) and level-order(L-order).
E - End to second section - Treasue Hunter.
...
= Please choose the instruction.      =
= (I)Import file                      =
= (C)Input hunter numbering           =
= (E)end                              =
=                                     =
=======================================

I - Read map file.
C - Input two hunters numbering to run map, and the path and result will record in "result.txt".
E - End the program.

Unit :
1.Binary search tree is bigger to right node, smaller to left node.
2.Delete node should notice the node has one child or two children, and change the postion of sub tree.
3.Level-order should know the height of tree, and print the data by level.
