...
2-Write new data by user.

3. When program get data will show "The persons in circular list are : " 
4. Enter the number of persons to be skipped and choose the direction.
5. Finally, screen will show the survive. 
6. All calculate resulst will output to the "result.txt".

Unit :

1.Read data to creat circular linked list.
2.Circular linked list : At the end of list should link to the start.
3.Record the length of the list for skipped remove time.
4.According to direction to reverse the list or not.
5.Remove the node pass by skipped number until length = 1, and the node of data is survive.
