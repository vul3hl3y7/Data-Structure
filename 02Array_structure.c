/*
*
*	Assigment 1 : Structs and Arrays
*	Writer : Meng Tseng Tasi
*


1.Use command "make" to makefile.
2.Use command "./hwa" to run program.

For the strat, you will see the menu in the following :
...
(1) to read the data from the file whuch user enter, if the file doesn't exist, it will show "No file.", and jump to menu.

If the file exists, the data will save to the structure.

(2) to show the data from the structure, if user didn't use (1) read file first, the structure is null.

(3) to write data to the file, if the file doesn't exist, it will create new null file.

If the ID is not a number, program will ask user enter again.
If the score of math or score of English is not between 0 to 100, program will ask user enter again.

If ID or Name is repeated, program cannot notice, it only read and write data.
